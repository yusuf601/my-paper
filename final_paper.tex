...
% Judul
\begin{center}
{\fontsize{24}{28}\selectfont\bfseries Segmentation of Provinces Prone to Food Crises Based on Commodity Price Volatility Patterns Using Fuzzy C-Means Clustering\par}
\vspace{0.3cm}
\end{center}
...
% Abstract in English
\noindent
\textbf{\textit{Segmentasi Provinsi Rawan Krisis pangan Berdasarkan Pola Harga Komoditas Pangan Menggunakan Algoritma Fuzzy C-Means Clustering}}
...
Setelah proses clustering menghasilkan jumlah cluster optimal, tahap interpretasi dilakukan untuk menganalisis karakteristik masing-masing cluster secara kuantitatif. Tahap ini bertujuan untuk menyediakan kerangka analisis yang sistematis dalam memahami perbedaan pola antar cluster, tanpa memberikan penilaian substantif terhadap makna cluster tersebut.

Untuk setiap cluster yang terbentuk, dihitung statistik deskriptif berupa nilai rata-rata dan standar deviasi dari setiap fitur yang digunakan dalam proses clustering. Statistik ini digunakan untuk membandingkan karakteristik relatif antar cluster dan mengidentifikasi fitur-fitur yang berkontribusi terhadap perbedaan pola antar kelompok.

Selain itu, algoritma Fuzzy C-Means menghasilkan derajat keanggotaan (\textit{membership degree}) \(u_{ik}\) yang merepresentasikan tingkat asosiasi suatu provinsi terhadap masing-masing cluster. Informasi derajat keanggotaan ini digunakan untuk mengidentifikasi tingkat kejelasan partisi cluster, termasuk objek dengan keanggotaan dominan serta objek yang berada pada wilayah transisi antar cluster. Interpretasi substantif terhadap hasil tersebut dibahas lebih lanjut pada bab hasil dan pembahasan.
